(function() {
  var html5editBaseUrl, html5editBuildr, html5editEl, scripts, styles, _ref;
  scripts = ['script/contenteditable.coffee', 'script/slice.coffee', 'script/selection.coffee', 'script/loaded.coffee'];
